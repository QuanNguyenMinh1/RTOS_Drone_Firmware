 ...
 *
 * https://github.com/ChrisWonyeobParka
...
void Double_Altitude_PID_Calculation(PIDDouble* axis, float set_point_alt, float alt/*BMP280 Altitude*/, float rate/*ICM-20602 Angular Rate*/)
{
	/*********** Double PID Outer Begin (Roll and Pitch Angular Position Control) *************/
	axis->out.reference = set_point_alt;	//Set point of outer PID control
	axis->out.meas_value = alt;			//BMP280 Altitude
...
void Reset_All_PID_Integrator(void)
{
	...
	Reset_PID_Integrator(&alt.in);
	Reset_PID_Integrator(&alt.out);
